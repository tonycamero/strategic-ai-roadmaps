...
exports.DELIVERY_SYNTHESIS = void 0;
exports.selectDeliverySynthesis = selectDeliverySynthesis;
exports.DELIVERY_SYNTHESIS = {
    SB_01: {
        ...
        diagnosis: "Delivery friction isn't caused by effort — it's caused by missing continuity."
    },
    SB_02: {
        ...
        diagnosis: "Execution drag compounds quietly, extending timelines and eroding trust."
    },
    SB_03: {
        ...
        diagnosis: "Delivery breakdowns surface externally, even when teams work hard internally."
    }
};
/**
 ...
 */
function selectDeliverySynthesis(answers) {
    const { Q1, Q2, Q3 } = answers;
    // Pattern 1: Handoff/context issues
    if ((Q1 === 'D1_HANDOFF' || Q1 === 'D1_SCOPE') &&
