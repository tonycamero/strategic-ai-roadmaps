...
exports.SALES_SYNTHESIS = void 0;
exports.selectSalesSynthesis = selectSalesSynthesis;
exports.SALES_SYNTHESIS = {
    SB_01: {
        ...
        diagnosis: "Sales execution breaks when attention shifts. Without enforced follow-up and shared context, revenue leaks silently even when demand exists."
    },
    SB_02: {
        ...
        diagnosis: "The system cannot scale attention. As volume rises, the team spends energy deciding what to do instead of executing consistently."
    },
    SB_03: {
        ...
        diagnosis: "Revenue appears healthy only because leadership absorbs systemic failure. This creates a hidden ceiling on growth."
    }
};
/**
 ...
 */
function selectSalesSynthesis(answers) {
    const { Q1, Q2, Q3 } = answers;
    // Pattern 1: Manual/memory failures with individual compensation
    if ((Q2 === 'S2_MANUAL' || Q2 === 'S2_CONTEXT') &&
