...
export const OPS_SYNTHESIS = {
    SB_01: {
        ...
        diagnosis:
            "The system functions only while people actively compensate. Under stress, fragility becomes visible and costly."
    },
    ...
    SB_02: {
        ...
        diagnosis:
            "Operational load grows without structural reinforcement, creating compounding risk and burnout."
    },
    ...
    SB_03: {
        ...
        diagnosis:
            "The organization is reactive by default. Without systemic correction, this pattern hardens."
    }
};
 ...
 */
export function selectOpsSynthesis(answers: { Q1?: string; Q2?: string; Q3?: string }): string {
    const { Q1, Q2, Q3 } = answers;

    // Pattern 1: Informal coordination / manual processes
    if (
        (Q1 === 'O1_HANDOFFS' || Q1 === 'O1_VISIBILITY') &&
        Q2 === 'O2_MANUAL'
    ) {
        return 'SB_01';
    }
