...
import type { AlignmentLevel } from './teamLogic';
...
): { template: TeamTemplate; summary: string } {
    const template = TEAM_TEMPLATES[primaryConstraint] || TEAM_TEMPLATES['Systemic Fragmentation'];
